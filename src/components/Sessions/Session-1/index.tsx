  ...
  return (
    <Base>
      <div className="h-screen grid grid-cols-12 relative">
        <img src={Ilustration1} alt="" className="absolute right-0 top-20 w-20 opacity-20" />
        <img src={Ilustration2} alt="" className="absolute left-0 top-36 w-28 opacity-20" />
        <img src={Ilustration3} alt="" className="absolute right-0 bottom-64 w-16 opacity-10" />
        <img src={Ilustration4} alt="" className="absolute left-20 bottom-36 w-32 opacity-30" />
        <div className=" col-span-12 flex flex-col items-center justify-center gap-4 ">
          <h1 className="font-Sora font-semibold text-center text-8xl">
            <span className="font-normal italic"><span className="text-9xl">F</span>ortalecendo</span> <br /> sua <span className="underline decoration-white	 text-amber-500 ">Idéia</span> com <br /> <span className="font-black">Ciência de Dados</span>
          </h1>
          <h1 className="font-normal text-center text-2xl">
            <span>
              <FiberManualRecordIcon className="text-amber-500" sx={{ fontSize: 12 }} />
            </span>{" "}
